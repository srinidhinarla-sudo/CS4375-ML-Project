...
direction for it to find. Every percentage point gained above 50\%
...
two datasets with different characteristics---one easy and
low-resolution, one harder and color---the modification reliably moves
...
is mild overfitting---training loss approaches its floor faster than
